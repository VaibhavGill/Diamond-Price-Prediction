    ...
    if 'model' not in st.session_state:
        ...
        with col1:
            ...
            if "clarity" in features:
                ...
                clarity_encoded = clarity_options[clarity]
        ...
        for feature in features:
            if feature == "carat":
                input_data[feature] = carat
            elif feature == "cut":
                input_data[feature] = cut_encoded
            elif feature == "color":
                input_data[feature] = color_encoded
            elif feature == "clarity":
                input_data[feature] = clarity_encoded
            elif feature == "depth":
                input_data[feature] = depth
            elif feature == "table":
                input_data[feature] = table
            elif feature == "x":
                input_data[feature] = x
            elif feature == "y":
                input_data[feature] = y
            elif feature == "z":
                input_data[feature] = z
